...
def run_smart_campus_pipeline(df):
    ...
    if required_cols.issubset(df.columns):
        ...
        priority_map = {cluster_priority.index[0]: 'Low',
        ...
        scaler = MinMaxScaler()
        hotspot_df['hotspot_score'] = scaler.fit_transform(hotspot_df[['hotspot_score']])
    ...
    # ---------- Case 2: Numeric input from frontend ----------
        ...
        df['severity'] = pd.cut(df['hotspot_score'], bins=[-1,0.3,0.6,1], labels=['Low','Medium','High'])
        return df
